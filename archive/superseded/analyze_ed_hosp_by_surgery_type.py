#!/usr/bin/env python3
"""
analyze_ed_hosp_by_surgery_type.py
...
COHORTS = {
    "with_BMI": "ed_hosp_binary_with_BMI.csv",
    "no_BMI":   "ed_hosp_binary_no_BMI.csv",
}
...
text = "\n".join(report)
with open("ed_hosp_surgtype_summary.txt", "w") as f:
    f.write(text)
pd.DataFrame(result_rows).to_csv("ed_hosp_surgtype_results.csv", index=False)
print(text)
print("\nWrote: ed_hosp_surgtype_summary.txt, ed_hosp_surgtype_results.csv")
