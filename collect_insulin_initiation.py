...
COHORTS = {
    "with_BMI": {
        ...
        "ed_hosp": "ed_hosp_binary_with_BMI.csv",
    },
    "no_BMI": {
        "dataset": "psm_matched_dataset_no_BMI.csv",
        "ed_hosp": "ed_hosp_binary_no_BMI.csv",
    },
}
...
text = "\n".join(report)
with open("insulin_initiation_summary.txt","w") as f:
    f.write(text)
print(text)
print("\nWrote: insulin_initiation_events_with_BMI.csv, "
      "insulin_initiation_events_no_BMI.csv, insulin_initiation_summary.txt")
