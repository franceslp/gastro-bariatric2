#!/usr/bin/env python3
"""
collect_diabetes_complications_optimal.py
...
COHORTS = {
       "with_BMI_optimal": {"dataset": "psm_matched_dataset_optimal.csv"},
   }
...
text = "\n".join(report)
with open("dm_complications_summary_optimal.txt","w") as f:
    f.write(text)
print(text)
